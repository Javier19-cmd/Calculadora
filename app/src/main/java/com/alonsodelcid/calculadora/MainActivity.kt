...
class MainActivity : AppCompatActivity() {
   //Variables globales.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resultadoText.text = "0"  //Esta variable es la encargada de escribir el texto en el UI de la calculadora. Al principio escribe cero, ya que no hay números ingresados por default.
        operacion = SIN_OPERACION //Se hace referencia a la variable SIN_OPERACION, que no contiene nada por operar o hacer en la calculadora.
    ...
    private fun operationPressed(operacion: Int){
        ...
        resultadoText.text = "0" //Se escribe 0 para que saber que sí se almacenó la operación correctamente.
    }
